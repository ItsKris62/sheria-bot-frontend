...
| **CL-08** | `Kenya regulatory sandbox CMA` | `CMA fintech sandbox Kenya`, `CMA regulatory sandbox policy note` | Commercial Investigation | MOFU | `/kenya/regulatory-sandbox-guide` | Deep Regulatory Guide | **P1 (High)** | Focus on CMA Regulatory Sandbox Policy Note 2019. |
...
| **CL-10** | `digital credit provider annual compliance return CBK` | `DCP annual return requirements Kenya`, `CBK DCP annual fee payment` | Commercial Investigation | MOFU | `/knowledge-base/cbk-dcp-annual-compliance-return-fees-guide` | Knowledge Base Article | **P1 (High)** | Capture yearly December 31 statutory return and fee deadline under Reg 5. |
...
│   └── /kenya/regulatory-sandbox-guide          (Guide: "Kenya regulatory sandbox", "CMA regulatory sandbox")
│
