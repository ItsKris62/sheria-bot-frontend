...
export default function RegisterPage() {
  ...
  const confirmMismatch = formData.confirmPassword !== "" && formData.password !== formData.confirmPassword
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!passwordStrength.isValid) {
      setError("Please make sure your password meets all requirements shown below.")
      return
    }
          ...
          {step === 1 ? (
            ...
            <>
              ...
              <div className="space-y-2">
                ...
                />
                {showFreeEmailWarning && (
                  <div id="email-warning" className="flex items-start gap-2 rounded-md border border-yellow-500/50 bg-yellow-500/10 px-3 py-2 text-xs text-yellow-700 dark:text-yellow-400" role="alert">
