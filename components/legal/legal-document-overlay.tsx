...
const META: Record<LegalDocType, DocMeta> = {
  privacy: {
    ...
    toc: [
      ...
      { id: "lawful-bases", label: "Lawful Bases for Processing (s.30)" },
      { id: "ai-processing", label: "AI & Vector Architecture" },
      { id: "subprocessors", label: "Third-Party Subprocessors" },
      { id: "cross-border", label: "Cross-Border Transfers" },
      { id: "cookies-telemetry", label: "Cookies & Telemetry" },
      { id: "retention", label: "Data Retention & Erasure" },
      { id: "data-subject-rights", label: "Data Subject Rights (Kenya DPA)" },
      { id: "security-breach", label: "Security & Breach Protocol" },
      { id: "complaints", label: "Regulatory Inquiries & Complaints" },
    ],
  },
  terms: {
  ...
  "data-protection": {
    ...
    toc: [
      ...
      { id: "architecture-subprocessors", label: "Architecture & Subprocessors" },
      { id: "ai-governance", label: "AI Governance & Data Isolation" },
      { id: "retention-disposal", label: "Retention & Purge Standards" },
      { id: "direct-marketing-governance", label: "Direct Marketing Governance" },
      { id: "security-safeguards", label: "Security Measures (TOMs)" },
      { id: "incident-response", label: "Incident & Breach Notification" },
      { id: "dsr-fulfillment", label: "Data Subject Rights (DSAR)" },
    ],
  },
  security: {
