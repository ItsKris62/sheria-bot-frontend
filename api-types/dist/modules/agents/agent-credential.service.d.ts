...
export declare const AGENT_CAPABILITIES: readonly ["agents.run.create", "agents.run.read", "agents.run.advance", "agents.run.complete", "agents.run.fail", "agents.report.create", "agents.regIntel.run.create", "agents.marketing.draft.create", "agents.marketing.draft.read", "agents.sales.draft.create", "agents.sales.draft.read", "agents.automation.log.create", "agents.automation.generate", "agents.automation.metrics.read", "agents.automation.approval.create", "agents.automation.approval.read", "agents.automation.content.publish", "agents.automation.content.queueCandidate", "agents.automation.content.createDraft", "agents.automation.content.generateDraft", "agents.automation.regulatoryItems.read", "agents.automation.approvedContent.read", "agents.automation.newsletter.send", "agents.automation.outreach.queue", "agents.automation.sources.read", "agents.automation.sources.fetch", "agents.automation.sources.dedupe", "agents.automation.pilotCohort.read", "agents.automation.dpaVendor.read", "agents.automation.notify.shouldNotify", "agents.productBi.report.create", "agents.productBi.report.read", "agents.securityOps.report.create", "agents.securityOps.report.read", "agents.chiefOfStaff.report.create", "agents.chiefOfStaff.report.read", "agents.automation.incident.create", "agents.automation.editorial.triage.create", "agents.automation.editorial.triage.read", "agents.automation.editorial.research.create", "agents.automation.editorial.research.read", "agents.automation.editorial.verify.create", "agents.automation.editorial.verify.read", "agents.automation.editorial.freshness.list", "agents.automation.editorial.freshness.run", "agents.automation.editorial.revision.create", "agents.automation.editorial.monitors.read", "agents.automation.editorial.discovery.run", "agents.automation.editorial.suggestions.read", "agents.automation.editorial.suggestions.create", "agents.automation.editorial.draft.create", "agents.automation.regulatory.sources.read", "agents.automation.regulatory.sources.fetch", "agents.automation.regulatory.snapshots.create", "agents.automation.regulatory.snapshots.read", "agents.automation.regulatory.items.create", "agents.automation.regulatory.items.read", "agents.automation.regulatory.alertDraft.create", "agents.automation.regulatory.enrichment.process", "agents.automation.regulatory.enrichment.listPending", "agents.marketing.leads.ingest"];
export type AgentCapability = (typeof AGENT_CAPABILITIES)[number];
export declare const AUTOMATION_CAPABILITIES: readonly AgentCapability[];
export declare const REGULATORY_AUTOMATION_CAPABILITIES: readonly AgentCapability[];
export declare const EDITORIAL_AUTOMATION_CAPABILITIES: readonly AgentCapability[];
export type AgentPrincipalId = 'sys-agent-orchestrator' | 'sys-automation-orchestrator' | 'sys-scheduler-orchestrator' | 'sys-regulatory-orchestrator' | 'sys-editorial-orchestrator';
